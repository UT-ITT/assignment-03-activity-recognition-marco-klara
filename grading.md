...
* the classifier recognizes activities correctly
    * semi, lifting is not as good as the others (2.5P)
...
* the fitness training application works and displays training activities and if they are executed correctly
    * no indicator whether you do the exercise wrong or not (0.5P)

## Bonus Points (1P)
In comparision with our data set you won **2nd Place!** You get a Bonus Point! 